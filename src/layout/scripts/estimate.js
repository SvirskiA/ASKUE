...
for (let i = 0; i < userInput.length; i += 1) {
	console.log(userInput[i], userInput[i].countOfSEM);
...
console.log(routing_4x16_cable_along_pylon_with_clamps_XK1, routing_4x16_cable_along_pylon_with_protection_cover_KM, 
	routing_4x16_cable_in_the_trench, routing_4x16_cable_along_remote_stand, purchase_4x16_cable_with_2_percent, routing_2x16_cable_along_pylon_with_clamps_XK1, excavation);
